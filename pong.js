...
Paddle.prototype.move = function(x, y) {
    ...
    if (this.x < 0) { //full left side
        this.x = 0;
        this.x_speed = 0;
    } else if (this.x + this.width > 400) { //full right side
...
Ball.prototype.update = function(paddle1, paddle2) {
    ...
    if (this.x - 5 < 0) { // hitting the wall
        this.x = 5;
    ...
    if (top_y > 300) { // hit the players paddle
        if (top_y < (paddle1.y + paddle1.height) && bottom_y > paddle1.y && top_x < (paddle1.x + paddle1.width) && bottom_x > paddle1.x) {
            this.y_speed = -3;
            this.x_speed += (paddle1.x_speed / 2);
            this.y += this.y_speed;
        }
    } else { // hit the computers paddle
